...
task:
  ...
  task_name: eng-map
  input: "{processo} — nome, trigger, saída esperada, atores"
  output: "mapa de processo com etapas, checkpoints, vetos e owners"
  action_items: "Coletar entradas; mapear etapas; definir checkpoints e vetos; nomear owners"
  acceptance_criteria: "Executor sem contexto consegue seguir o processo sem ambiguidade"
```
