...
task:
  ...
  task_name: auto-connect
  input: "{sistema_a} {sistema_b}"
  output: "mapeamento source→target, transformações e vetos de integração"
  action_items: "Mapear campos; definir transformações; declarar fallback"
  acceptance_criteria: "Integração determinística, com rastreabilidade e fallback explícito"
```
