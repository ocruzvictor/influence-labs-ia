...
task:
  ...
  task_name: eng-owners
  input: "{processo} já mapeado"
  output: "matriz etapa → dono nomeado"
  action_items: "Listar etapas; atribuir dono; vetar etapa órfã"
  acceptance_criteria: "Nenhuma etapa sem dono; nenhum dono sem etapa"
```
