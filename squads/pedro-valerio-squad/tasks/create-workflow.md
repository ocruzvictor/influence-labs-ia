...
task:
  ...
  task_name: create-workflow
  input: "{name} + fases e agentes"
  output: "workflow YAML multi-step com checkpoints e handoffs"
  action_items: "Definir fases; checkpoints; handoffs; compensação"
  acceptance_criteria: "Workflow executável, fases ordenadas, vetos e rastreabilidade"
```
