...
task:
  ...
  task_name: arq-statuses
  input: "{workflow} ou entidade com ciclo de vida"
  output: "máquina de estados com transições e condições"
  action_items: "Listar estados; definir transições; documentar entrada e saída"
  acceptance_criteria: "Nenhum estado válido fica sem entrada e sem saída documentadas"
```
