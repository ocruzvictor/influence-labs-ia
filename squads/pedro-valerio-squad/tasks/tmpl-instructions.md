...
task:
  ...
  task_name: tmpl-instructions
  input: "{processo}"
  output: "instruções de preenchimento passo a passo"
  action_items: "Derivar passos do processo; remover julgamento implícito"
  acceptance_criteria: "Executor consegue concluir o processo sem suporte externo"
```
