...
task:
  ...
  task_name: auto-rules
  input: "{sistema} + processo já mapeado (*eng-map)"
  output: "regras determinísticas com trigger, condição e veto"
  action_items: "Derivar regras do processo; tornar condições booleanas; listar vetos"
  acceptance_criteria: "Toda regra tem trigger verificável e veto que impede execução incorreta"
```
