...
PACER foi o baseline (P-ersona / A-ção / C-ontexto / E-xemplos / R-estrições). Bom para começar, mas misturou "instrução operacional" com "informação estática" — exatamente o que a recepção Bonfim alertou que faz a IA pular linhas. Crisp segmenta mais fino:
