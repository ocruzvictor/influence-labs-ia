...
Ao aplicar, anota no MEMORY/story: **data + versão (`v3.1.0`)**. O prompt vivo é `docs/prompts/tess-conversa-v3-clean.md`; snapshots em `docs/prompts/archive/`; changelog em `docs/prompts/CHANGELOG-46589.md`.
